...
<?php
    ...
    $id = $_SESSION['id'];
    $sql_query_count_blog = "SELECT COUNT(*) AS total_blog FROM cms_message WHERE type_id = '1' and student_id = '$id'";
    $sql_query_count_request = "SELECT COUNT(*) AS total_request FROM cms_message WHERE type_id = '2' and student_id = '$id'";
    $sql_query_count_m2t = "SELECT COUNT(*) AS total_m2t FROM cms_message WHERE type_id = '3' and student_id = '$id'";
    $sql_query_count_mft = "SELECT COUNT(*) AS total_mft FROM cms_message WHERE type_id = '4' and student_id = '$id'";
